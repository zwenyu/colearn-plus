...
def data_load(args): 
    ...
    dsets["source_tr"] = ImageList(tr_txt, transform_adapt=image_train())
    dset_loaders["source_tr"] = DataLoader(dsets["source_tr"], batch_size=train_bs, shuffle=True, 
        num_workers=args.worker, drop_last=True)
    dsets["source_te"] = ImageList(te_txt, transform_adapt=image_test())
    dset_loaders["source_te"] = DataLoader(dsets["source_te"], batch_size=train_bs*3, shuffle=False, 
        num_workers=args.worker, drop_last=False)
    dsets["test"] = ImageList(txt_test, transform_adapt=image_test())
...
if __name__ == "__main__":
    ...
    args.output_dir_src = osp.join(args.output, args.da, args.dset, names[args.s], str(SEED))
