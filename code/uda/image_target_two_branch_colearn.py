...
- Training data loader that returns
    - image path, pseudolabel to train with, pseudolabeling indicator
...
def finetune(args, dset_loaders, adapt_netF, adapt_netB, adapt_netC, pretrained_netF):
    ...
    for param in adapt_netC.parameters():
        param.requires_grad = False
    centroids = method_utils.get_centroids(args, dset_loaders['target_all'], adapt_netF, adapt_netB, adapt_netC, pretrained_netF, None,
