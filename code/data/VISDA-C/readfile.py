'''
This script generates the files for DA methods
Obtained from https://github.com/tim-learn/Generate_list
Run with python readfile
'''

import os

folder = '/home/zhang_wenyu/DATA/DA_datasets/VisDA/'
...
for d in range(len(domains)):
	...
	if os.path.isdir(os.path.join(folder, dom)):
		...
		classes = [i for i in classes if '.txt' not in i]
		classes.sort()
		# print(classes)
